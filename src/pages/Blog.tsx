...
const articles = [
  ...
  },
  {
    ...
    excerpt: "Les points à vérifier côté contenu, connexion et équipement avant de regarder du sport en ultra haute définition.",
    date: "8 juillet 2026",
    readTime: "4 min",
    icon: FiWifi,
    category: "Sport",
  ...
  },
  {
    ...
    excerpt: "Une méthode simple pour vérifier contenus, qualité, fonctions et compatibilité pendant l'essai gratuit.",
    date: "1 juillet 2026",
    readTime: "3 min",
    icon: FiTv,
    category: "Guide",
  },
  {
    ...
    excerpt: "Comprendre les outils, les coûts et les responsabilités d'un pack revendeur avant de démarrer.",
    date: "28 juin 2026",
    readTime: "8 min",
    icon: FiWifi,
    category: "Business",
