            ...
            <div className="lg:col-span-2 space-y-5">
              {[
                ...
                },
                {
                  icon: FiMapPin,
                  title: "Support",
                  value: "Assistance technique disponible 7j/7",
                  href: null,
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="border border-white/[0.04] rounded-xl p-5 bg-[#111d32]/30 hover:border-white/[0.08] transition-all"
                >
                  ...
                  {item.href ? (
                    <a
                      ...
                      className="text-white/50 text-base hover:text-[#6b7c5c] transition-colors ml-[52px]"
                    >
                      {item.value}
                    </a>
                  ) : (
                    <p className="text-white/50 text-base ml-[52px]">
                      {item.value}
                    </p>
                  )}
                </div>
              ...
              <div className="border border-[#5a6b4e]/15 rounded-xl p-5 bg-[#5a6b4e]/5">
                ...
                <p className="text-white/60 text-base font-light">
                  {COMMERCIAL_INFO.support.description}
                </p>
              </div>
            </div>
                ...
                {!submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div>
                        <label
                          ...
                          className="flex items-center gap-2 text-base text-white/55 mb-2"
                        >
                          <FiUser className="w-4 h-4" /> Nom
                        </label>
                        <input
                          id="contact-name"
                          type="text"
                      ...
                      <div>
                        <label
                          ...
                          className="text-base text-white/55 mb-2 block"
                        >
                          Sujet
                        </label>
                        <select
                        ...
                        >
                          ...
                          <option value="technical" className="bg-[#0a1628]">
                            Support technique
                          </option>
                          <option value="billing" className="bg-[#0a1628]">
                            Facturation
                          </option>
                          <option value="reseller" className="bg-[#0a1628]">
                            Programme revendeur
                          </option>
                      ...
                      <button
                        type="submit"
                        className="w-full py-4 text-base font-semibold text-white bg-[#5a6b4e] rounded-xl hover:bg-[#4d5d42] transition-all flex items-center justify-center gap-2"
                      >
                  ...
                  >
                    ...
                    <h3 className="font-display font-bold text-2xl text-white mb-2">
                      Message préparé dans WhatsApp
                    </h3>
                    <p className="text-white/50 text-base mb-6 font-light">
                      Appuyez sur « Envoyer » dans WhatsApp pour transmettre
                      réellement votre message.
                    </p>
                    <div className="flex flex-col items-center gap-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-[#6b7c5c] hover:text-[#8aaf8a] transition-colors text-base"
                      >
                        Rouvrir WhatsApp
                      </a>
                      <Link
