...
const tutorials = [
  {
    ...
    steps: [
      ...
      "Recherchez l’application compatible indiquée par le support et vérifiez le nom de son éditeur",
      "Installez-la uniquement depuis la boutique intégrée à votre téléviseur",
      "Suivez la procédure d’activation correspondant à votre modèle",
      "Après confirmation de l’activation, saisissez les identifiants reçus",
      "Rechargez la liste et vérifiez le catalogue disponible",
    ],
    tips: "Les applications et les menus disponibles varient selon la marque, le modèle, le pays et la version du téléviseur. Confirmez la compatibilité avec le support avant l’installation.",
  },
  {
    id: "androidtv",
    icon: FiMonitor,
    ...
    steps: [
      ...
      "Recherchez l’application compatible indiquée par le support",
      "Vérifiez son éditeur puis installez-la depuis le Play Store",
      "Ouvrez l’application et choisissez le mode de connexion confirmé par le support",
      "Entrez uniquement les identifiants reçus après l’activation",
      "Rechargez la liste et vérifiez le catalogue disponible",
    ],
    tips: "Les menus peuvent varier selon la box et la version d’Android TV. Vérifiez votre modèle avec le support avant de commander.",
  },
  {
    id: "firestick",
    icon: FiBox,
    ...
    steps: [
      "Ouvrez l’Amazon Appstore depuis l’écran d’accueil",
      "Recherchez l’application compatible indiquée par le support",
      "Vérifiez son éditeur et installez-la uniquement depuis l’Appstore",
      "Ouvrez l’application et choisissez le mode de connexion confirmé par le support",
      "Entrez uniquement les identifiants reçus après l’activation",
      "Rechargez la liste et vérifiez le catalogue disponible",
    ],
    tips: "Si aucune application compatible n’est proposée dans la boutique officielle, contactez le support pour vérifier une autre solution compatible avec votre modèle.",
  },
  {
    id: "iphone",
    icon: FiSmartphone,
    name: "iPhone / iPad",
    steps: [
      "Ouvrez l’App Store et recherchez l’application compatible indiquée par le support",
      "Vérifiez son éditeur puis installez-la depuis l’App Store",
      "Ouvrez l’application et consultez ses conditions d’utilisation",
      "Choisissez le mode de connexion confirmé par le support",
      "Entrez uniquement les identifiants reçus après l’activation",
      "Rechargez la liste et vérifiez le catalogue disponible",
    ],
  ...
  },
  {
    ...
    name: "Android Phone",
    steps: [
      "Ouvrez le Google Play Store et recherchez l’application compatible indiquée par le support",
      "Vérifiez son éditeur puis installez-la depuis le Play Store",
      "Ouvrez l’application et choisissez le mode de connexion confirmé par le support",
      "Entrez uniquement les identifiants reçus après l’activation",
      "Rechargez la liste et vérifiez le catalogue disponible",
